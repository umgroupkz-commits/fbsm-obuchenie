...
const ACH_KAT_U = {
  ...
  x_grom:{st:'Громоотвод',nm:'Громоотвод',kat:'Антикубки',anti:true,pogoda:true,
    zk:'Погода «Шторм» — 30–49 личных штрафных баллов за 90 дней',
  ...
  x_uragan:{st:'Сорванная крыша',nm:'Сорванная крыша',kat:'Антикубки',anti:true,pogoda:true,zk:'Погода «Ураган» — 50–79 личных баллов за 90 дней',
    fr:'Антикубок из ржавой мятой жести в форме домика с сорванной бурей крышей, постамент — трухлявая доска'},
  x_krasnaya:{st:'Красный флаг',nm:'Красный флаг',kat:'Антикубки',anti:true,pogoda:true,zk:'Погода «Красная зона» — 80 и больше личных баллов, разбор с руководством',
