...
seller:[
 ...
 {t:'Профиль и награды', cel:'act:achprofil',
  txt:['Нажмите на человека — откроется его карточка. В шапке три плитки: сколько наград, стаж и день рождения. '
      ...
      +'антирейтинга (15 и 30 штрафных баллов) и уходят сами, когда счёт опустится; выданные за поведение стоят, '
      +'пока таких нарушений за 30 дней не станет меньше; остальные вручает руководство на срок от 1 до 30 дней. В карточке антикубка написано прямо: на зарплату и награды он не влияет.'],
