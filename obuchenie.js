...
function menyu(){
  ...
  ?[{g:'Моя работа'},
    ...
    {ic:'💰',l:'Моя ЗП',fn:'pgRunnerZP'},
    {g:'Магазин'},{ic:'📅',l:'График',fn:'pgSchedule'}]
  :CU.role==='streammgr'
  ?[{g:'Моя работа'},{ic:'💰',l:'Моя ЗП',fn:'pgEfirZP'},
    {g:'Магазин'},{ic:'📅',l:'График',fn:'pgSchedule'}]
  :CU.role==='streamer'
  ?[{g:'Моя работа'},
    {ic:'➕',l:'Ввод продаж',fn:'pgEnter'},{ic:'📋',l:'История',fn:'pgHist'},
    {ic:'💰',l:'Моя ЗП',fn:'pgStreamZP'},
    {g:'Магазин'},{ic:'📅',l:'График',fn:'pgSchedule'}]
  :CU.role==='seller'
  ?[{g:'Моя работа'},
    {ic:'📊',l:'Дашборд',fn:'pgDash'},{ic:'➕',l:'Ввод продаж',fn:'pgEnter'},
    {ic:'📋',l:'История',fn:'pgHist'},
    {g:'Магазин'},
    {ic:'📅',l:'График',fn:'pgSchedule'},{ic:'🏆',l:'Рейтинг',fn:'pgRating'},
    {ic:'🏪',l:'Отчёт магазина',fn:'pgShopReport'}]
  :CU.role==='manager'
  ?[{g:'Магазин'},
    {ic:'📊',l:'Сводка',fn:'pgReport'},{ic:'📅',l:'График',fn:'pgSchedule'},
    {ic:'🏪',l:'Отчёт магазина',fn:'pgShopReport'},{ic:'🏆',l:'Рейтинг',fn:'pgRating'},
    {g:'Люди'},{ic:'👤',l:'Сотрудники',fn:'pgSellers'},
    {g:'Деньги'},{ic:'💹',l:'Моя ЗП',fn:'pgMgrDash'},{ic:'💰',l:'Начисление ЗП',fn:'pgPayroll'}]
  :CU.role==='accountant'
  ...
  :[{g:'Магазины'},
    ...
    {g:'Люди'},{ic:'👤',l:'Сотрудники',fn:'pgSellers'},
    {g:'Деньги'},{ic:'💰',l:'Начисление ЗП',fn:'pgPayroll'},
    {ic:'🎯',l:'Планы',fn:'pgPlans'},{ic:'⚙️',l:'Параметры',fn:'pgParams'}];
}
...
window.pgSchedule = function(){
  ...
  if(mozhet){
    h += '<div style="display:flex;flex-wrap:wrap;gap:8px;align-items:center;margin-bottom:.75rem">'
      + '<button class="btn bsm'+(_kist?' bp':'')+'" onclick="uchKist()">'
...
manager:[
 ...
 {t:'Заполните и отправьте', cel:'act:otchet',
  ...
  zad:'Впишите число посетителей и нажмите «Отправить отчёт».', tyk:'#uch-vis'},
 {t:'График — включите кисть', otkryt:'pgSchedule', cel:'act:kist',
  ...
  zad:'Откройте «График» и включите кисть.', tyk:'#n-pgSchedule,#s-pgSchedule'},
...
admin:[
 ...
 {t:'Смените должность и сохраните', cel:'act:sohranil',
  ...
  zad:'Выберите другую должность и нажмите «Сохранить».', tyk:'#uch-rol'},
 ...
 {t:'Параметры расчёта', otkryt:'pgParams', cel:'act:param',
  txt:['Сетка зарплаты у каждой должности своя. Изменения действуют сразу и на текущий '
      ...
      +'не редактируется.'],
  zad:'Откройте «Параметры» и нажмите «Сохранить параметры».', tyk:'#n-pgParams,#s-pgParams'},
 {t:'Журнал',
...
const tr = {
  ...
  podsvetit(){
    ...
    s.tyk.split(',').forEach(sel=>{
      const el = document.querySelector(sel.trim());
      if(el) el.classList.add('tr-tyk');
    });
  },
  ...
  sobytie(chto){
    ...
    if(!s || this.gotovo || !s.cel) { this.verh(); return; }
