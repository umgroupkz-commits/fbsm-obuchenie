...
const ACH_U = [
  ...
  {n:'Акишева Жанар', d:'Продавец-кассир · Асфендиярова', dost:67,
   ...
   anti:[{code:'x_muha',den:'16 сентября 2026',za:'3 опоздания за 30 дней',
     srok:'пока таких нарушений за 30 дней не станет меньше'}]},
];
let _achVklU = 'lyudi';
...
seller:[
 ...
 {t:'Профиль и награды', cel:'act:achprofil',
  txt:['Нажмите на человека — откроется его карточка. В шапке три плитки: сколько наград, стаж и день рождения. '
      ...
      +'три правки задним числом, «Грабли» — четыре одинаковых нарушения; срока у них нет, уходят, когда нарушений '
      +'станет меньше, и больше одного такого сразу не бывает. Остальные вручает руководство на срок от 1 до 30 дней — '
