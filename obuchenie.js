...
const BALL_PRAVILA_U = [
  ...
  ['Отчёт магазина сдан позже дня смены (пока не сдан — день не идёт в зарплату, поэтому его сдают, и это уже «с опозданием»)', '1 каждому', 'все, кто был на смене в магазине, и управляющий магазина'],
...
// Повторяет боевую 2026-09-20 · 24: статуэтки — картинками из stat/, карточка
// сотрудника — счётчик видов, «Путь», «Рекорды» и «Полка наград», антикубки —
// на «Пыльной полке». Имена и описания статуэток взяты из каталога наград.
const ACH_STAT = 'https://umgroupkz-commits.github.io/fbsmsalemanagers/stat/';
const ACH_KAT_U = {
  m_prodavec:{st:'Вега',nm:'Продавец месяца',kat:'Месяц: победители',f:'пятиконечная звезда на тонкой игле',
    m:'горный хрусталь на серебряной игле, основание — белый мрамор',
    za:'лучший сводный результат месяца в сети: план, средний чек и UPT'},
  p_plan100:{st:'Десятка',nm:'План 100 %',kat:'Месяц: пороги',f:'мишень со стрелой точно в центре',
    m:'дуб, стрела — латунь',za:'выполнение личного плана месяца'},
  p_chek:{st:'Пятнашка',nm:'Чек 15 000',kat:'Месяц: пороги',f:'чековая лента с выбитым числом 15',
    m:'клён с выжженным числом',za:'средний чек месяца от 15 000 ₸'},
  k_kassa:{st:'Сейф',nm:'Касса квартала',kat:'Квартал',f:'сейф с приоткрытой дверцей',
    m:'чёрный мрамор с золотым замком',za:'кассу, сходившуюся все три месяца квартала'},
  n_privet:{st:'Кораблик',nm:'Добро пожаловать',kat:'Новичкам',f:'сложенный кораблик',
    m:'плотная бумага, покрытая лаком',za:'подключение учётной записи — ты на борту'},
  r_den:{st:'Планка',nm:'Личный рекорд дня',kat:'Рекорды',f:'стойки с планкой для прыжков в высоту',
    m:'металл по числу наград; постамент — серый мрамор',
    za:'побитый собственный лучший день по продажам',rost:'chislo'},
  r_mesyac:{st:'Вершина',nm:'Лучший месяц',kat:'Рекорды',f:'горный пик с флажком',
    m:'металл по числу наград; постамент — кусок скальной породы',
    za:'самый сильный месяц продаж за всё своё время',rost:'chislo'},
  r_zadachi:{st:'Турбина',nm:'Свой рекорд задач',kat:'Рекорды',f:'турбина с лопатками',
    m:'металл по числу наград; постамент — титан',
    za:'больше задач в срок за месяц, чем когда-либо раньше',rost:'chislo'},
  r_1m:{st:'Слиток дня',nm:'Миллион за смену',kat:'Рекорды',f:'банковский слиток с выбитой датой',
    m:'металл по числу наград; постамент — чёрный гранит',
    za:'личные продажи от 1 000 000 ₸ за один день',rost:'chislo'},
  l_prodazhi:{st:'Монетный столб',nm:'Личные продажи',kat:'Ступени',f:'стопка монет — с каждой ступенью выше',
    m:'металл по ступени; постамент — зелёный мрамор',
    za:'сумму личных продаж за всё время: от 1 до 250 млн ₸',rost:'stupen',
  ...
  l_smeny:{st:'Подкова',nm:'Смены',kat:'Ступени',f:'подкова с гвоздями',
    m:'металл по ступени; постамент — кузнечная сталь',
    za:'число отработанных смен: от 10 до 1 000',rost:'stupen',
  ...
  l_stazh:{st:'Годовые кольца',nm:'Стаж в FBSM',kat:'Ступени',f:'срез ствола с годовыми кольцами',
    m:'металл по годам; постамент — кап берёзы',
    za:'месяц, полгода и каждую годовщину работы в компании',rost:'stupen',
    lest:['Первый месяц','Полгода','1 год','2 года','3 года','5 лет','10 лет','15 лет','20 лет'],
    suf_lest:['med','bronza','serebro','serebro','zoloto','platina','sapfir','izumrud','brilliant'],
    met_lest:['med','bronza','serebro','serebro','zoloto','platina','sapfir','izumrud','brilliant'],
    beskonechno:true},
  l_kursy:{st:'Сова',nm:'Курсы',kat:'Ступени',f:'сова, сидящая на стопке книг',m:'белый фарфор',
    za:'каждый сданный курс обучения — одна сова за курс, копятся стопкой',skoro:true},
  x_zont:{st:'Дырявый зонт',nm:'Дырявый зонт',kat:'Антикубки',f:'раскрытый зонт со сломанной спицей и дырой в куполе',
    m:'ржавая жесть; постамент — трухлявая доска',
    za:'погоду «Зонт обязателен» — 15 и больше штрафных баллов',anti:true,pogoda:true},
  x_grom:{st:'Громоотвод',nm:'Громоотвод',kat:'Антикубки',f:'погнутый штырь, в который бьёт молния',
    m:'горелое железо; постамент — трухлявая доска',
    za:'погоду «Штормовое предупреждение» — 30 и больше штрафных баллов',anti:true,pogoda:true},
  x_kosyak:{st:'Мистер Косяк',nm:'Мистер Косяк',kat:'Антикубки',f:'человечек, наступивший на собственные шнурки',
    m:'гнутая проволока и жесть; постамент — трухлявая доска',za:'косяк — причина указана при выдаче',anti:true},
  x_muha:{st:'Сонная муха',nm:'Сонная муха',kat:'Антикубки',f:'муха, уснувшая на будильнике',
    m:'потемневшее олово; постамент — трухлявая доска',za:'хронические опоздания',anti:true},
  x_girya:{st:'Ржавая гиря',nm:'Ржавая гиря',kat:'Антикубки',f:'пудовая гиря с цепью',
    m:'ржавый чугун; постамент — трухлявая доска',za:'то, что подвёл команду',anti:true},
  x_grabli:{st:'Грабли',nm:'Грабли',kat:'Антикубки',f:'грабли, на которые уже наступали',
    m:'рассохшееся дерево и ржавое железо; постамент — трухлявая доска',
    za:'повторение одной и той же ошибки',anti:true},
  x_zerkalo:{st:'Кривое зеркало',nm:'Кривое зеркало',kat:'Антикубки',f:'зеркало в перекошенной раме',
    m:'мутное стекло в гнутой латуни; постамент — трухлявая доска',za:'приукрашенные цифры и отчёты',anti:true},
  x_kopilka:{st:'Разбитая копилка',nm:'Разбитая копилка',kat:'Антикубки',f:'свинья-копилка с отколотым боком',
    m:'треснувшая глина; постамент — трухлявая доска',za:'небрежность с деньгами и товаром',anti:true},
  x_kaktus:{st:'Кактус',nm:'Кактус',kat:'Антикубки',f:'кактус в щербатом горшке',
    m:'позеленевшая медь; постамент — трухлявая доска',za:'грубость с клиентом или коллегой',anti:true},
};
...
const ACH_ORD_U = [
  ...
  ['Квартал',           [['k_kassa',1]]],
  ['Рекорды',           [['r_den',2],['r_1m',1],['r_mesyac',0],['r_zadachi',0]]],
  ['Ступени',           [['l_smeny',3],['l_stazh',3],['l_prodazhi',1],['l_kursy',0]]],
  ['Новичкам',          [['n_privet',2]]],
  ['Антикубки',         [['x_zont',1],['x_muha',1],['x_kosyak',0],['x_grabli',0],['x_girya',0],
                         ['x_zerkalo',0],['x_kopilka',0],['x_kaktus',0],['x_grom',0]]],
];
...
const achMetU = g => { const k = ACH_KAT_U[g.code]; return k.rost==='chislo' ? achMetallU(g.n||1) : (k.rost==='stupen' ? g.met : null); };
const achSrcU = g => {
  const k = ACH_KAT_U[g.code];
  if(k.rost==='chislo') return ACH_STAT+g.code+'__'+achMetallU(g.n||1)+'.webp';
  if(k.rost==='stupen') return ACH_STAT+g.code+'__'+g.suf+'.webp';
  return ACH_STAT+g.code+'.webp';
};
...
// Описание по шаблону настоящей статуэтки: форма → материал → за что.
const achOpisU = g => {
  const k = ACH_KAT_U[g.code], met = achMetU(g);
  const mat = met ? (ACH_METALL_U[met]||'металл')+'; '+k.m.split('; ').slice(-1)[0] : k.m;
  return `<b>«${esc(k.st)}»</b> — ${esc(k.nm)}
    <div style="font-size:12.5px;line-height:1.5;margin-top:4px"><span style="color:var(--muted)">Форма:</span> ${esc(k.f)}
    <br><span style="color:var(--muted)">Материал:</span> ${esc(mat)}
    <br><span style="color:var(--muted)">Вручается за</span> ${esc(k.za)}</div>`;
};
...
const ACH_U = [
  {n:'Забабурина Александра', d:'Продавец-консультант · Республика', dost:67, ya:true, g:[
    ...
    {code:'l_prodazhi',za:'Личных продаж за всё время — 5 млн ₸',den:'22 августа 2026',suf:'t3',met:'serebro',stup:2},
    {code:'l_smeny',za:'Сотая смена',den:'14 августа 2026',suf:'serebro',met:'serebro',stup:2},
    {code:'l_stazh',za:'Год в FBSM',den:'3 июня 2026',suf:'serebro',met:'serebro',ur:'1 год',
  ...
  {n:'Торебай Гулжайкын', d:'Продавец-консультант · Манаса', dost:67, g:[
    {code:'n_privet',za:'Учётная запись подключена — добро пожаловать',den:'11 августа 2026'},
    {code:'l_smeny',za:'Десятая смена',den:'27 августа 2026',suf:'med',met:'med',stup:0},
    {code:'l_stazh',za:'Первый месяц в FBSM',den:'11 сентября 2026',suf:'med',met:'med',ur:'первый месяц',
     dalshe:'до «полгода» — ещё 4 месяца',pct:22}],
  ...
  {n:'Акишева Жанар', d:'Продавец-кассир · Асфендиярова', dost:67, g:[
    ...
    {code:'l_smeny',za:'Пятидесятая смена',den:'2 июля 2026',suf:'bronza',met:'bronza',stup:1},
    {code:'l_stazh',za:'Полгода в FBSM',den:'3 сентября 2026',suf:'bronza',met:'bronza',ur:'полгода',
     dalshe:'до «1 год» — ещё 5 месяцев',pct:18}],
   anti:[{code:'x_muha',den:'16 сентября 2026',za:'Хронические опоздания — вручил руководитель',srok:'ещё 4 дня'}]},
];
let _achVklU = 'lyudi';
// Карточка сотрудника — та же, что в программе: счётчик видов, «Путь»,
// «Рекорды», «Полка наград», ниже — «Пыльная полка».
const achKartochkaU = (p,i) => {
  const sobrano = p.g.length;
  let h = `<div style="display:flex;align-items:center;gap:8px"><div style="flex:1;height:8px;background:var(--s2);border-radius:99px;overflow:hidden">
  ...
  if(lest.length){
    ...
    lest.forEach(g => {
      const k = ACH_KAT_U[g.code];
      const bar = k.lest
        ? `<div style="display:flex;gap:3px;margin:6px 0 3px">${k.lest.map((s,j)=>`<div style="flex:1;height:6px;border-radius:99px;background:${j<=g.stup?'var(--blue)':'var(--s2)'}"></div>`).join('')}</div>`
        : `<div style="height:6px;background:var(--s2);border-radius:99px;overflow:hidden;margin:5px 0 3px"><div style="width:${g.pct}%;height:100%;background:var(--blue)"></div></div>`;
      const dalshe = k.lest
        ? (g.stup+1 < k.lest.length ? `ступень ${g.stup+1} из ${k.lest.length} · дальше — «${k.lest[g.stup+1]}»` : `все ${k.lest.length} ступени пройдены`)
        : g.dalshe;
      h += `<div style="display:flex;align-items:center;gap:10px;border:1px solid var(--border);border-radius:var(--r);padding:8px 10px;margin-bottom:6px">
        ${achStatU(g,44)}<div style="flex:1;min-width:0"><div style="font-weight:600;font-size:14px">${esc(k.nm)} · ${esc(k.lest?k.lest[g.stup]:g.ur)}</div>
        ${bar}<div style="font-size:12px;color:var(--muted)">${esc(dalshe)}</div></div></div>`;
    });
  }
  ...
  if(rek.length){
    h += `<div class="ct" style="margin:1rem 0 .5rem">Рекорды</div><div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px">`
      + rek.map(g => `<div style="display:flex;gap:8px;align-items:center;border:1px solid var(--border);border-radius:var(--r);padding:7px 8px;min-width:0">
        ${achStatU(g,40)}<div style="min-width:0"><div style="font-size:12px;color:var(--muted)">${esc(ACH_KAT_U[g.code].nm)}</div>
        <div style="font-size:12.5px;font-weight:600;line-height:1.3">${esc(g.za)}</div>
  ...
  h += `<div class="ct" style="margin:1rem 0 .6rem">Полка наград</div>
    ...
    + p.g.map((g,j) => achKubokU({g, n:g.n||1, znachok:g.n>1?'×'+g.n:'', podpis:ACH_KAT_U[g.code].st, sub:ACH_KAT_U[g.code].nm,
        attrs:`id="uch-ach-n-${j}" onclick="uchAchNagrada(${i},${j})"`})).join('')
    + `</div>`;
  if(p.anti && p.anti.length){
    h += `<div class="ct" style="margin:1.2rem 0 .3rem;color:var(--red)">Пыльная полка</div>
      <div style="font-size:12px;color:var(--muted);margin-bottom:.5rem">Антикубки временные — уйдут сами, когда выйдет срок или исправится погода. В счётчик наград они не входят.</div>`
      + p.anti.map((g,j) => `<button id="uch-ach-a-${j}" onclick="uchAchNagrada(${i},${j},1)" style="display:flex;gap:10px;align-items:center;width:100%;text-align:left;padding:8px;border:1px dashed var(--red);border-radius:var(--r);background:var(--rl);margin-bottom:6px;cursor:pointer;color:var(--text);font:inherit">
        ${achStatU(g,56)}<span style="min-width:0"><span style="display:block;font-weight:600">«${esc(ACH_KAT_U[g.code].st)}»</span>
        <span style="display:block;font-size:12.5px">${esc(g.za)}</span>
        <span style="display:block;font-size:11.5px;color:var(--red)">${esc(g.srok)}</span></span></button>`).join('');
  }
  return h;
};
  ...
  if(_achVklU==='ordena'){
    setContent(tabs + ACH_ORD_U.map(([kat,spisok]) => `<div class="card" style="max-width:640px">
      ...
      + spisok.map(([code,lyudey],j) => { const k = ACH_KAT_U[code];
          return achKubokU({g:{code,n:1,suf:(k.suf_lest||[])[0],met:(k.met_lest||[])[0]}, n:lyudey,
...
window.uchAchProfil = function(i){
  ...
  ov.innerHTML = `<div class="ovc" style="max-width:640px">
    ...
    ${achKartochkaU(p,i)}
    <div class="rnote">Нажмите на статуэтку — откроется её расшифровка: форма, материал и за что она вручается.</div></div>`;
  document.body.appendChild(ov);
  tr.sobytie('act:achprofil');
};
// Окно одной награды: крупная статуэтка, описание и — у своей — «Поделиться».
window.uchAchNagrada = function(i,j,anti){
  const p = ACH_U[i], g = anti ? p.anti[j] : p.g[j], k = ACH_KAT_U[g.code];
  const ov = document.createElement('div'); ov.className = 'ov'; ov.id = 'uch-ach-vr'; ov.style.zIndex = 110;
  ov.innerHTML = `<div class="ovc" style="max-width:560px">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:.75rem">
      <div style="display:flex;gap:12px;align-items:center;min-width:0">${achStatU(g,84)}
      <div style="min-width:0"><div style="font-size:17px;font-weight:700">${esc(k.nm)}</div>
      <div style="font-size:13px">${esc(p.n)} · ${esc(g.den||'решение руководства')}</div></div></div>
      <button class="btn bsm" id="uch-ach-vr-zakryt" onclick="this.closest('.ov').remove()">✕</button></div>
    <div style="margin-bottom:.5rem;line-height:1.5">${esc(g.za)}</div>
    <div style="background:var(--s2);border-radius:var(--r);padding:10px 12px;margin:.4rem 0">${achOpisU(g)}</div>
    ${anti ? `<div class="alert ae" style="display:block;margin-top:.6rem">Антикубок — ${esc(g.srok)}.</div>
      <div class="rnote">Поделиться антикубком нельзя. В общий чат программа пишет о нём иначе, чем о награде:
        «ставит на полку антикубок «…»» и до какого числа он простоит — или что он уйдёт сам, когда улучшится погода.</div>`
      : (p.ya ? `<button class="btn bp bbl tr-tyk" id="uch-ach-podelitsya" style="margin-top:1rem" onclick="uchAchPodelitsya(this)">📤 Поделиться наградой</button>
        <div class="rnote">Кнопка есть только у своей награды: чужой поделиться нельзя.</div>`
        : `<div class="rnote">Поделиться можно только своей наградой — у чужой кнопки нет.</div>`)}</div>`;
  document.body.appendChild(ov);
  if(window.tr && tr.podsvetit) tr.podsvetit();
};
window.uchAchPodelitsya = function(b){
  const box = b.closest('.ovc');
  box.innerHTML = `<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem"><b>Открытка готова</b>
    ...
    <div style="background:var(--s2);border-radius:var(--r);padding:14px;text-align:center">
      ${achStatU({code:'m_prodavec'},120)}<div style="font-weight:700;margin-top:6px">«Вега» · Продавец месяца</div>
      <div style="font-size:12.5px;color:var(--muted)">Забабурина Александра · август 2026</div></div>
    <div class="rnote">Программа рисует картинку 1080×1350 — формат ленты. Сумм продаж на ней нет: только статуэтка, награда и за что.
      Картинка сохраняется в телефон, дальше вы отправляете её сами, куда хотите.</div>`;
  tr.sobytie('act:achpodel');
};

// Окно ордена: описание статуэтки, у рекордов — линейка металла,
// у лестниц — все ступени со своим металлом и теми, кто на них стоит.
window.uchAchOrden = function(code){
  const k = ACH_KAT_U[code];
  const mat = k.rost==='chislo' ? 'металл растёт с числом наград; '+k.m.split('; ').slice(-1)[0]
    : k.rost==='stupen' ? 'металл закреплён за ступенью; '+k.m.split('; ').slice(-1)[0] : k.m;
  // Кто получил — считаем по нашим трём сотрудникам.
  const kto = [];
  ...
  let h = `<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:.75rem">
      <div style="display:flex;gap:12px;align-items:center;min-width:0">${achStatU({code,n:1,suf:(k.suf_lest||[])[0],met:(k.met_lest||[])[0]},84)}
    ...
    <div style="line-height:1.55;margin-bottom:.6rem">${esc(k.za)}</div>
    <div style="background:var(--s2);border-radius:var(--r);padding:10px 12px;margin-bottom:1rem">
      <b>«${esc(k.st)}»</b><div style="font-size:12.5px;line-height:1.5;margin-top:4px"><span style="color:var(--muted)">Форма:</span> ${esc(k.f)}
      <br><span style="color:var(--muted)">Материал:</span> ${esc(mat)}
      <br><span style="color:var(--muted)">Вручается за</span> ${esc(k.za)}</div></div>`;
  if(k.rost==='chislo'){
  ...
  if(k.rost==='stupen'){
    h += `<div class="ct">Ступени</div><div class="tw-wrap"><table><tr><th>Ступень</th><th>У кого</th></tr>`
      + k.lest.map((nm,j) => { const u = kto.filter(([, g]) => g.stup===j || (g.ur||'')===nm.toLowerCase()).map(([n]) => n);
          return `<tr><td style="white-space:nowrap">${achStatU({code,suf:k.suf_lest[j]},36)} ${esc(nm)}
      ...
      + `</table></div>${k.beskonechno?`<div class="rnote">У стажа ступени не кончаются: месяц, полгода и дальше каждый год.</div>`:''}`;
  }
...
seller:[
 ...
 {t:'Антирейтинг', cel:'page:pgAntireiting',
  txt:['Баллы ставит программа сама, ночью, за нарушения. Балл живёт 90 дней и сгорает сам. '
      ...
      +'сдан позже дня смены — по баллу каждому, кто был на смене; касса не закрыта до 06:00 следующего дня — '
 ...
 {t:'Профиль и награды', cel:'act:achprofil',
  txt:['Нажмите на человека — откроется его карточка. Сверху счётчик: сколько видов наград собрано из тех, что доступны '
      +'по должности. «Путь» — лестницы с полоской и подписью, какая ступень следующая. «Рекорды» — только личные: '
      +'виден лучший и сколько раз он бит. «Полка наград» — все статуэтки, одинаковые стоят стопкой с ×N.',
       'Ниже — «Пыльная полка»: антикубки. Они временные и в счётчик наград не входят. «Дырявый зонт» и «Громоотвод» '
      +'приходят от погоды антирейтинга (15 и 30 штрафных баллов) и уходят сами, когда счёт опустится; остальные '
      +'вручает руководство на срок от 1 до 30 дней, и там написано, сколько ещё осталось.'],
  zad:'Откройте профиль Александры Забабуриной.', tyk:'#uch-ach-p-0,#uch-ach-lyudi'},
 {t:'Поделиться наградой', cel:'act:achpodel',
  txt:['Нажмите на статуэтку — откроется расшифровка: форма, материал и за что вручается. У своей награды там же есть '
      +'«📤 Поделиться наградой»: программа рисует открытку 1080×1350 с именем статуэтки. Сумм продаж на открытке нет. '
      +'О новой награде программа и так пишет в общий чат Битрикса — с именем статуэтки и строкой материала; '
      +'про антикубок текст другой, там сказано, до какого числа он простоит.'],
  zad:'Откройте первую статуэтку на полке и нажмите «Поделиться наградой».',
 ...
 {t:'Ордена', cel:'act:achorden',
  txt:['Вкладка «Ордена» — все награды компании по категориям, теми же статуэтками, что стоят на полке. '
      ...
      +'орден: форма, материал, условие, у рекордов — линейка, как растёт металл, у лестниц — все ступени и кто на них.'],
...
manager:[
 ...
 {t:'Антирейтинг', cel:'page:pgAntireiting',
  txt:['Баллы ставит программа сама, ночью, за нарушения. Балл живёт 90 дней и сгорает сам. '
      +'До 30 сентября идёт проверка, 1 октября — амнистия: счёт обнулится, и дальше всё всерьёз.',
       'Вас касаются: прогул — 10 баллов; отчёт магазина сдан позже дня смены — балл каждому на смене '
...
streammgr:[
 ...
 {t:'Антирейтинг', cel:'page:pgAntireiting',
  txt:['Баллы ставит программа сама, ночью, за нарушения. Балл живёт 90 дней и сгорает сам. '
      +'До 30 сентября идёт проверка, 1 октября — амнистия: счёт обнулится, и дальше всё всерьёз.',
       'Вас касаются: прогул — 10 баллов; отчёт магазина сдан позже дня смены — по баллу всем на смене; '
...
{t:'Антикубок на срок', cel:'act:achvruchit',
  txt:['Вручаете награды и антикубки только вы. У антикубка обязательно есть срок: 7 дней по умолчанию, '
      ...
      +'антирейтинга. Руками выдаются «Мистер Косяк» и ещё шесть — гиря, зеркало, муха, копилка, кактус, грабли.'],
